...
class TestTweetDfExtractor(unittest.TestCase):
    ...
    def test_find_statuses_count(self):
        self.assertEqual(self.df.find_statuses_count(), [40, 40, 40, 40, 40])  # [204051, 3462, 6727, 45477, 277957])
    ...
    def test_find_full_text(self):
        ...
        #     'Former Pfizer VP and Virologist, Dr. Michael Yeadon, is one of the most credentialed medical professionals speaking out about the dangers of the #Covid19 vaccines, breaks down his “list of lies” that keeps him up at night. https://t.co/LSE8CrKdqn',
        #     'I think it’s important that we don’t sell COVAX short. It still has a lot going for it and is innovative in its design. But it needs more vaccines to share.  We’re hoping our low cost @TexasChildrens recombinant protein COVID19 vaccine with @biological_e will help fill some gaps']
    ...
    def test_find_created_time(self):
        ...
        # created_at = ['Fri Jun 18 17:55:49 +0000 2021', 'Fri Jun 18 17:55:59 +0000 2021',
    ...
    def test_find_followers_count(self):
        f_count = [3, 3, 3, 3, 3]  # [551, 66, 1195, 2666, 28250]
        self.assertEqual(self.df.find_followers_count(), f_count)

    def test_find_friends_count(self):
        friends_count = [12, 12, 12, 12, 12]  # [351, 92, 1176, 2704, 30819]
    ...
    def test_find_favourite_count(self):
        self.assertEqual(self.df.find_favourite_count(), [2356, 1985, 16, 1242, 1329])  # [548, 195, 2, 1580, 72])

    def test_find_retweet_count(self):
        self.assertEqual(self.df.find_retweet_count(), [355, 505, 4, 332, 386])  # [612, 92, 1, 899, 20])
