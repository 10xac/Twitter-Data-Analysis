...
def insert_to_tweet_table(dbName: str, df: pd.DataFrame, table_name: str) -> None:
    ...
    for _, row in df.iterrows():
        sqlQuery = f"""INSERT INTO {table_name} (id,created_at, source, polarity, subjectivity, language,
...
if __name__ == "__main__":
    ...
    df = pd.read_csv(r'C:\Users\Jakinda\Documents\Python Scripts\Twitter-Data-Analysis\data\cleanData.csv')
