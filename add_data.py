...
def createTables(dbName: str) -> None:
    ...
    """
    conn, cur = DBConnect(dbName)
    sqlFile = '/home/stacy/Downloads/Twitter-Data-Analysis-fix_bug/tests/Twitter-Data-Analysis/task5_schema.sql'
    fd = open(sqlFile, 'r')
    readSqlFile = fd.read()
    fd.close()
...
def preprocess_df(df: pd.DataFrame) -> pd.DataFrame:
    ...
    """
    cols_2_drop = ['Unnamed: 0', 'timestamp', 'sentiment', 'possibly_sensitive', 'original_text', 'user_mentions']
    try:
...
if __name__ == "__main__":
    ...
    df = pd.read_csv('/home/stacy/Downloads/cleaned_fintech_data.csv')
