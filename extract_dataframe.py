...
class TweetDfExtractor:
    ...
    def find_source(self)->list:
        source = [tweet['created_at'] for tweet in self.tweets_list]
    ...
    def get_tweet_df(self, save=False)->pd.DataFrame:
        ...
        columns = ['created_at', 'source', 'text', 'lang', 'favorite_count', 'retweet_count', 
...
if __name__ == "__main__":
    # required column to be generated you should be creative and add more features
    columns = ['created_at', 'source', 'original_text', 'clean_text', 'lang', 'favorite_count', 'retweet_count', 
    'original_author', 'screen_count', 'followers_count','friends_count','possibly_sensitive', 'hashtags', 'user_mentions', 'place', 'place_coord_boundaries']
    _, tweet_list = read_json("merged-ke-ng-sa.json")
