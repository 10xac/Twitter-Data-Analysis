...
class TweetDfExtractor:
    ...
    def get_tweet_df(self, save=True)->pd.DataFrame:
        ...
        if save:
            df.to_csv('C:/Users/Success/visual_try/data/Economic_Twitter_Data.zip/Economic_Twitter_Data.csv', index=False)
...
if __name__ == "__main__":
 # Extract zip file in current directory
    with ZipFile('C:/Users/Success/visual_try/data/Economic_Twitter_Data.zip', 'r') as zipfile:
        zipfile.extractall()
    _, tweet_list = read_json("C:/Users/Success/visual_try/data/Economic_Twitter_Data.json")
