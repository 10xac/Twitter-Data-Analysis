...
class TweetDfExtractor:
    ...
    def find_retweet_count(self)->list:
        ...
        retweet_count = [self.tweets_list[i]["user"]['retweet_count'] for i in range(self.tweets_length)]
    ...
    def get_tweet_df(self, save=False)->pd.DataFrame:
        ...
        columns = ['created_at', 'source', 'text', 'fav_count', 'screen_name', 'follower_count', 'friends_count']#, sensitivity#['created_at', 'source', 'original_text','polarity','subjectivity', 'lang', 'favorite_count', 'retweet_count', 
       ...
       # hashtags = self.find_hashtags()
        ...
        data = zip(created_at, source, text, fav_count, screen_name, follower_count, friends_count)
