...
class TweetDfExtractor:
    ...
    def find_full_text(self)->list:
        try:
            text = [tweet['retweeted_status']['extended_tweet']['full_text'] for tweet in self.tweets_list]
    ...
    def find_sentiments(self, text)->list:
        polarity = [TextBlob(txt).polarity for txt in text]
        subjectivity = [TextBlob(txt).subjectivity for txt in text]
    ...
    def find_favourite_count(self)->list:
        try:
            favourite_count = [tweet['retweeted_status']['favorite_count'] for tweet in self.tweets_list]
        except KeyError:
            favourite_count = [None for tweet in self.tweets_list]
    ...
    def find_retweet_count(self)->list:
        try:
            ...
            retweet_count = [None for tweet in self.tweets_list]
    ...
    # this will store the extracted data as .scv extension 
