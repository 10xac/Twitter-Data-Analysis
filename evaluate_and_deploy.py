...
def deploy_better_models():
    try:
        ...
        sentiment_return = compare_sentiment_models(prev_desc, new_desc)
        validated_description['sentiment_analysis']['name'] = sentiment_return[0]
        validated_description['sentiment_analysis']['score'] = sentiment_return[1]

        topic_return = compare_topic_models(prev_desc, new_desc)
        validated_description['topic_modeling']['perplexity_score'] = topic_return[0]
        validated_description['topic_modeling']['coherence_score'] = topic_return[1]
        ...
        if(change_sentiment == 1):
            ...
            joblib.dump(sentiment_model,
                        './trained_models/sentimentSGDmodel.jl')
        ...
        joblib.dump(validated_description,
                    './trained_models/trainedModelsData.jl')
